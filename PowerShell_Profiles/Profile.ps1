...
Set-Environment "LS_OPTIONS" "--escape --human-readable --more --color --recent --streams"
# Deprecated - Use alias or script. See profile-alias.ps1
#Set-Environment "GREP_OPTIONS" "--binary-files=text -d skip --color=auto"
